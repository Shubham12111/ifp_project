...
urlpatterns = [
    ...
    path('add/', login_required(ToDoAddUpdateView.as_view()), name='todo_add'),  # URL for creating new todo (POST)
    path('edit/<int:pk>/', login_required(ToDoAddUpdateView.as_view()), name='todo_edit'),
